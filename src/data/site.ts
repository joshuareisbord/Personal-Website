export const site = {
  ...
  about: [
    ...
    'As a developer, my passion lies in designing and developing innovative applications that cater to specific niches and make the daily lives of users more manageable and enjoyable. You can browse my projects on GitHub.',
  ],
  email: 'joshuareisbord@gmail.com',
  phone: '+1 (310) 351-1198',
  phoneHref: 'tel:+13103511198',
