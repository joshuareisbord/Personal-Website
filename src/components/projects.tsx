...
const ProjectElement: React.FC<{ project: Project, img: string }> = ({ project, img }) => {
    ...
    const doEdit = () => {
        const path = {
            ...
            search: `?docId=${project.id}&new=false`
        }
        navigate(path)
        ...
        <div className="relative mb-4 w-full md:w-1/2 lg:w-1/3 px-4 hover:scale-105">
            <div className="relative h-80 mb-5 mx-auto rounded-lg">
                ...
                <div className="absolute inset-0 p-6 flex flex-col items-start">
                    ...
                    {/* <a className="inline-block py-2 px-4 border-2 border-green-500 hover:border-white bg-transparent text-gray-50 hover:bg-white hover:text-gray-900 transition duration-200 rounded-l-xl rounded-t-xl font-bold leading-loose"
                       href={`${ROUTES.edit}$docID=${project.id}`}>
                        Edit Project
                    </a> */}
                    <a className="inline-block py-2 px-4 border-2 border-green-500 hover:border-white bg-transparent text-gray-50 hover:bg-white hover:text-gray-900 transition duration-200 rounded-l-xl rounded-t-xl font-bold leading-loose"
                        onClick={() => doEdit()}
...
export const Projects: React.FC = () => {
    ...
    return (
        <section className="flex flex-col content-center relative py-20 bg-gray-900 radius-for-skewed">
            ...
            <div className="w-screen py-10 mx-auto lg:mx-0 text-center">
                    <div>
                        <a className="inline-block mb-3 lg:mb-0 lg:mr-3 w-2/3 lg:w-1/3 py-2 px-6 leading-loose bg-green-600 hover:bg-green-700 text-white font-semibold rounded-l-xl rounded-t-xl transition duration-200" 
